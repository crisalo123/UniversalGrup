...
export const BannerMigrations: React.FC<BannerMigrationsProps> = ({
  img,
  navigations,
  logo,
  isProtours,
  ...
  const subText = isProtours ? "md:mx-2" : "mx-3";
    ...
    >
      ...
      >
        ...
        <Button
          ...
          className={`bg-gradient-to-r h-12 text-lg ${isProtours ? "bg-yellow-500" : "bg-blue-800"}   hover:bg-gradient-to-l  transition duration-300 ease-in-out px-6 py-3 rounded-lg shadow-lg`}
        >
          {ctaText}
        </Button>
      </motion.div>
