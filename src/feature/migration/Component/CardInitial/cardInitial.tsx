...
export const CardInitial: React.FC<CardInitialProps> = ({
  backgroundImage,
  buttonshow,
  subtitle,
  title,
  ...
  return (
    <section
      className="relative bg-cover pb-10 md:pb-0 pt-10 md:pt-0 bg-center min-h-[70vh] flex items-center justify-center px-6"
      style={{ backgroundImage: `url(${backgroundImage})` }}
    >
      <div className="bg-white/80 p-10 rounded-3xl max-w-2xl text-center shadow-xl border border-blue-200">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight text-red-600 font-pacifico drop-shadow-lg">
          {title}
        </h1>
        <p className="text-xl mb-6 text-blue-800 font-semibold">{subtitle}</p>
        {buttonshow && (
          <Link
