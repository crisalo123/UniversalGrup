      ...
      <section className="max-w-5xl mx-auto mt-16 mb-20 px-4 py-12 rounded-3xl bg-white/80 shadow-xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-700">
              Te guiamos en cada paso, desde la documentación hasta la
              entrevista.
            </p>
          </div>
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-700">
              Optimiza tu tiempo y aumenta tus posibilidades de aprobación.
            </p>
          </div>
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-700">
              Disfruta tu viaje a USA con la tranquilidad de tener todo en
              regla.
            </p>
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto mb-20 px-4">
        ...
        <ol className="space-y-6">
          <li className="flex items-start gap-4">
            <span className="bg-red-400 text-white font-bold rounded-full w-8 h-8 flex items-center justify-center">
              1
            </span>
            <div>
              <span className="font-semibold">Evaluación personalizada:</span>{" "}
              Analizamos tu perfil y te orientamos sobre los requisitos.
            </div>
          </li>
          <li className="flex items-start gap-4">
            <span className="bg-red-400 text-white font-bold rounded-full w-8 h-8 flex items-center justify-center">
            ...
            <div>
              <span className="font-semibold">Preparación de documentos:</span>{" "}
              Te ayudamos a reunir y organizar toda la documentación necesaria.
            </div>
          </li>
          <li className="flex items-start gap-4">
            <span className="bg-red-400 text-white font-bold rounded-full w-8 h-8 flex items-center justify-center">
            ...
            <div>
              <span className="font-semibold">Simulación de entrevista:</span>{" "}
              Practica con nosotros para que llegues seguro a tu cita en la
              embajada.
            </div>
          </li>
          <li className="flex items-start gap-4">
            ...
            <div>
              <span className="font-semibold">¡Listo para viajar!</span> Recibe
              tu visa y prepárate para disfrutar USA.
            </div>
          </li>
        </ol>
      </section>
