...
import { CardInitial } from "../migration/Component/CardInitial";

const testimonios = [
  {
    nombre: "María López",
    historia:
      "Gracias a Universal Migrations, ahora estudio en Nueva York y mi inglés ha mejorado muchísimo. ¡Una experiencia inolvidable!",
    foto: "https://randomuser.me/api/portraits/women/44.jpg",
  },
  {
    nombre: "Carlos Pérez",
    historia:
      "El acompañamiento fue total, desde la visa hasta la llegada. Hoy tengo nuevas oportunidades en EE.UU.",
    foto: "https://randomuser.me/api/portraits/men/32.jpg",
  },
  {
    nombre: "Ana Torres",
    historia:
      "Nunca imaginé que aprender inglés en el extranjero fuera tan fácil. ¡Gracias por ayudarme a cumplir mi sueño!",
...
export const MigrationsPage = () => {
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 pt-10 pb-16">
      ...
      <CardInitial
        title="Visa de Estudiante para Estados Unidos"
        backgroundImage={studentImg}
        subtitle="¡Estudia Inglés Intensivo en Estados Unidos y Abre las Puertas a un Futuro Brillante!"
        buttonshow={true}
      />
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-700">
              Te guiamos paso a paso en todo el proceso de solicitud y
              requisitos para tu visa de estudiante.
            </p>
          </div>
          <div className="flex flex-col items-center">
            <FaUniversity className="text-blue-600 text-5xl mb-4" />
            <h3 className="font-bold text-lg mb-2">
              Acceso a Instituciones Top
            </h3>
            <p className="text-gray-700">
              Te ayudamos a elegir las mejores escuelas y universidades en
              EE.UU. según tus metas.
            </p>
          </div>
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-700">
              Vive una experiencia única, mejora tu inglés y amplía tus
