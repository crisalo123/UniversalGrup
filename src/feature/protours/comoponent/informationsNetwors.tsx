...
export const InformationsNetwors = () => {
  return (
     <section
      className=" absolute py-20 px-6 bg-no-repeat bg-right   w-full bg-opacity-50 !text-blue-900"
    ...
    >
        ...
        <div className="flex justify-center space-x-6">
          {[
            ...
            >
              <span className="text-4xl !text-blue-900">{social.icon}</span>
              <span className="!text-blue-900">{social.name}</span>
            </Link>
          ))}
        </div>
      </section>
